...
export function Window({ windowId, children }: WindowProps) {
  ...
  const style: React.CSSProperties = win.isMaximized
    ...
    : { left: boundedX, top: boundedY, width: boundedWidth, height: boundedHeight, maxWidth: workspace.width, maxHeight: workspace.height, zIndex: win.zIndex, borderRadius: 8 };
  ...
  return (
    ...
    >
      {/* Title bar */}
      <div
        className="window-titlebar flex items-center justify-between px-3"
      ...
      >
        <div className="flex items-center gap-2 select-none">
          ...
          <span className="text-[12px] font-normal text-white/80">{win.title}</span>
        </div>
